...
export const projects = [
  ...
  //   category: ['design'],
  //   tags: ['Poster', 'Album Cover'],
  //   image: taylorsVersionImg,
  //   orientation: 'portrait',
  //   description: 'An anime-style reimagining of the album cover, complete with a full hand-lettered tracklist.',
  // },
  // {
  //   id: 'another-way',
  //   title: 'Another You, Another Way',
  //   category: ['design'],
  //   tags: ['Poster', 'Lyric Edit'],
  //   image: anotherWayImg,
  //   orientation: 'portrait',
  //   description: 'A dusky pier scene paired with sweeping display type, built around an Against The Current lyric.',
  // },
  {
    id: 'back-to-friends',
